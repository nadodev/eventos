      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold">Formatura 2024</h3>
                    <p className="text-sm text-muted-foreground">Engenharia de Software</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-green-50 p-3 rounded-lg">
                    <p className="text-sm font-medium text-green-700">150 inscritos</p>
                  </div>
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <p className="text-sm font-medium text-blue-700">R$ 15.000 arrecadados</p>
                  </div>
                </div>
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 bg-yellow-100 p-4 rounded-full">
              <span className="text-2xl">🎉</span>
            </div>
            <div className="absolute -bottom-4 -left-4 bg-purple-100 p-4 rounded-full">
              <span className="text-2xl">📅</span>
            </div>
          </div>
        </div>
