      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="text-2xl font-bold mb-4">🎓 EventosUni</div>
            <p className="text-gray-400 mb-6 max-w-md">
              A plataforma mais completa para organização de eventos universitários. 
              Simplifique sua vida acadêmica conosco.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <span className="block">📧 contato@eventosuni.com</span>
              </li>
              <li className="text-gray-400">
